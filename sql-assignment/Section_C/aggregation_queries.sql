...
-- Q16. For each order status, find the count of orders and the total 
-- revenue. Sort the result by total revenue in descending order.
...
-- Q18. List all product categories where the average unit_price is greater 
-- than ₹2000. (Hint: Use HAVING clause)
SELECT category, AVG(unit_price) AS avg_price
FROM products
GROUP BY category
